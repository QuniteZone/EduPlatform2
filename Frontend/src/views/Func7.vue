        ...
        <el-main id="chat">
          ...
          >
            ...
            <div class="chat-bubble user">
              <img src="@/image/user-icon.png" alt="用户图标" class="user-icon"/>
              {{ item.question }}
            </div>
            <!-- 机器人消息 -->
            <div class="chat-bubble bot">
              <img src="@/image/bot-icon.png" alt="机器人图标" class="bot-icon"/>
              {{ item.answer }}
            </div>
          </div>
        </el-main>
...
async function sendMsg() {
  if (form.input.length > 0) {
    ...
    try {
      ...
      form.msgList[lastMsgIndex].answer = ""; // 初始化为空字符串
      ...
      while (true) {
        ...
        // 更新消息内容
        form.msgList[lastMsgIndex].answer += resultData;
